  ...
  if (i % 2 == 1 ){
    ...
    while(incomingByte != '!' && Serial2.available() > 0){
     ...
     // Serial1.println(last_cmd_time);
      ...
      if (check == true ) {
        last_cmd_time = time_now; // heyheyheyheyheyheyheyhyehyehyeyhbce kavu cevi jeabusajevu
  ...
  */
   ...
   if (i % 2 == 0 ){
    ...
    while(incomingByte != '!' && Serial2.available() > 0){
      ...
      check = checkSum(incomingByte, siglen, cmd);
      if (check == true ) {
        last_cmd_time = time_now; //tttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
        speed_now = String(cmd[1]);
        //speed_now = data.toInt();
        voltage = String(cmd[3])+ String(cmd[4]) + String(cmd[5]);
        //voltage = data.toInt();
